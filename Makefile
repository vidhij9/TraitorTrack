.PHONY: test test-unit test-integration test-security test-fast coverage help load-test stress-test db-scale-test
...
test:
	...
	@echo ""
	@TESTING=True FORCE_DEV_DB=1 pytest tests/ -v
	@echo ""
...
test-unit:
	...
	@TESTING=True FORCE_DEV_DB=1 pytest tests/test_models.py -v

# Run integration tests
test-integration:
	@echo "🧪 Running integration tests..."
	@TESTING=True FORCE_DEV_DB=1 pytest tests/test_auth.py tests/test_bags.py tests/test_bills.py -v

# Run security tests
test-security:
	@echo "🧪 Running security tests..."
	@TESTING=True FORCE_DEV_DB=1 pytest tests/test_security.py -v

# Run fast tests (unit + integration)
test-fast:
	@echo "🧪 Running fast tests..."
	@TESTING=True FORCE_DEV_DB=1 pytest tests/ -v -m "not slow"

# Run tests with coverage report
coverage:
	@echo "🧪 Running tests with coverage..."
	@TESTING=True FORCE_DEV_DB=1 pytest tests/ --cov=. --cov-report=html --cov-report=term
	@echo ""
...
load-test:
	...
	@echo "   Start server: gunicorn --bind 0.0.0.0:5000 --reuse-port --reload main:app"
	@echo ""
