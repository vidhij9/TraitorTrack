...
from flask import Flask, request, g, session, flash, redirect, url_for
...
def create_app():
    ...
    app.config["SQLALCHEMY_ENGINE_OPTIONS"] = {
        ...
        "pool_timeout": 30,  # Increase connection timeout for better stability
    }
    ...
    def before_request():
        ...
        if current_user.is_authenticated and not request.path.startswith('/static/'):
            ...
            try:
                ...
                logger.error(f"Session security error: {str(e)}")
    ...
    def after_request(response):
        ...
        if hasattr(g, 'start_time'):
            ...
            logger.info(f"Request to {request.path} completed in {request_duration:.4f}s")
